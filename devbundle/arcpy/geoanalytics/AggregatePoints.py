...
class AggregatePoints(object):
    ...
    def description(self) -> str:
        ...
        AggregatePoints_geoanalytics(point_layer, output_name, polygon_or_bin, {polygon_layer}, {bin_type}, {bin_size}, {time_step_interval}, {time_step_repeat}, {time_step_reference}, {summary_fields;summary_fields...}, {data_store}, {bin_resolution})
