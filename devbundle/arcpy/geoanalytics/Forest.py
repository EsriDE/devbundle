    ...
    def description(self) -> str:
     ...
     INPUTS:
      ...
      create_variable_importance_table {Boolean}:
          ...
          the importance of each explanatory variable used in the
          model.CREATE_TABLE-The output table will contain information for each
          explanatory variable.NO_TABLE-The output table will not contain
