    ...
    def description(self) -> str:
     ...
     INPUTS:
      ...
      statistics_fields {Value Table}:
          ...
          parameter.
      multi_part {Boolean}:
          Specifies whether multipart features will be included in the
          output.MULTI_PART-Multipart features will be included in the output.
          This is
          the default.SINGLE_PART-Multipart features will not be included in the
          output.
