    ...
    def description(self) -> str:
     ...
     INPUTS:
      ...
      multi_part {Boolean}:
          ...
          feature class.MULTI_PART-Multipart features will be allowed in the
          output feature
          class. This is the default.SINGLE_PART-Multipart features will not be
          allowed in the output
          feature class. Individual features will be created for each part.
      unsplit_lines {Boolean}:
          Specifies how line features will be dissolved.DISSOLVE_LINES-Lines
          will be dissolved into a single feature. This is
          the default.UNSPLIT_LINES-Lines will only be dissolved when two lines
          have an end
          vertex in common.
